...
if user_lib.is_user_logged_in() and not st.session_state.quiz_completed:
    ...
    if st.session_state.quiz_completed:
        if st.button("Done", key="done_button", type="primary"):
            st.session_state.quiz_completed = True
            st.rerun()
...
if 'streaks' not in st.session_state:
    st.session_state.streaks = {
        ...
        "Walk or Bike 1 Kilometer Instead of Driving 🚶‍♀️🚴‍♂️": False,
...
if user_lib.is_user_logged_in() and menu == "Streaks":
    ...
    streaks = {
        ...
        "Walk or Bike 1 Kilometer Instead of Driving 🚶‍♀️🚴‍♂️": "Replace a short trip with walking or biking.",
